...
def TrackImages():
    ...
    exists3 = os.path.isfile(r"Pass_Train\Trainner.yml")
    if exists3:
        recognizer.read(r"Pass_Train\Trainner.yml")
    else:
    ...
    if exists:
        with open(r"Attendance\Attendance_" + date + ".csv", 'a+', newline='') as csvFile1:
            writer = csv.writer(csvFile1)
